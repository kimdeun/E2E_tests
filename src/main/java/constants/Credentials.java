...
public class Credentials {
    ...
    public static final String USER_NAME = "Dima";
    ...
    public static final String SEALS_IN_BAG_FOR_CREATING_WORK_ORDER = "10";
    public static final String SEAL_TYPE = "SealTypeForAutoTests";
